          ...
          <div className="row">
            <div className="col-lg-6 col-md-7">
              ...
              <p className="font-md-color-grey-900 wow animate__animated animate__fadeIn">
                Share discoveries on the world of Logistic, find curiosities
                about cargo services, produce insights on how intelligent agents
                work.
              </p>
            </div>
          </div>
      ...
      <section className="section mt-85">
        <div className="container">
          <div className="box-tags text-center">
            <Link
              className="btn btn-tags wow animate__animated animate__fadeIn"
              href="#"
            >
              Logistics
            </Link>
