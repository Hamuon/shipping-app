...
export default function Hero4Slider() {
  ...
  return (
    <>
          ...
          <div className="card-offer hover-up">
            ...
            <div className="card-info">
              ...
              <p className="font-sm color-grey-900 mb-35">
                We are professional in ocean freight with more than 12 years of
                experience and have shipped more than 100k shipments.
              </p>
      ...
      <div className="swiper-pagination swiper-pagination-banner swiper-pagination-style-2 swiper-pagination-group-4"></div>
    </>
  );
}
