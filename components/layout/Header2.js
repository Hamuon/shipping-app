  ...
  return (
    <>
      ...
      <header
        className={
          scroll
            ? "header sticky-bar  header-style-2 stick"
            : "header sticky-bar  header-style-2"
        }
      >
        <div className="container">
            ...
            <div className="header-contact">
              <div className="box-header-contact-1 mr-30">
                <div className="icon-contact">
                  ...
                  <img
                    alt="transp"
                    src="/assets/imgs/page/homepage3/address.png"
                  />
                </div>
              ...
              <div className="box-header-contact-2">
                <div className="icon-contact">
                  ...
                  <img
                    alt="transp"
                    src="/assets/imgs/page/homepage3/phone.png"
                  />
                </div>
                <div className="info-contact">
                  65 Allerton Street 901 N Pitt Str, USA
          ...
          <div className="main-header">
            <div className="header-left">
              <div className="header-logo d-inline-block d-md-none">
                <Link className="d-flex" href="/">
