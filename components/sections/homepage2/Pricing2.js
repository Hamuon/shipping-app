        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-4 col-md-4 text-end">
              <div className="text-center mt-10 wow animate__animated animate__fadeIn">
                <span className="text-md color-grey-900 text-billed-month">
                  Bill Monthly
                </span>
                ...
                <span className="text-md color-grey-900 text-billed-year">
                  Bill Annually
                </span>
              </div>
            </div>
          ...
          <div className="row mt-50 align-items-end pricing-style-2">
            <div className="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeIn">
              <div className="card-plan hover-up">
                ...
                <p className="font-md color-grey-500 desc-plan">
                  Advanced features for pros who need more customization.
                </p>
                <div className="item-price-plan">
                  <div className="for-month display-month">
                    <h3 className="color-brand-2 d-inline-block">
                      $<span>{!isToggled ? "125" : "1500"}</span>
                    </h3>
                    <span className="color-grey-500 font-sm">
                  ...
                  <div className="for-year">
                    ...
                    <span className="color-grey-500 font-sm">/year</span>
                  </div>
                </div>
                ...
                <div className="mt-20">
                  <Link className="btn btn-brand-2-full hover-up" href="#">
                    Get Started
                    <svg
