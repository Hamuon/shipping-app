        ...
        <div className="container">
          ...
          <div className="row align-items-end">
            <div className="col-lg-8 col-md-8 mb-30">
              <p className="font-md color-gray-700 wow animate__animated animate__fadeInLet">
          ...
          <div className="row mt-30 align-items-center">
            <div className="col-lg-6 mb-30">
              <div className="box-image-why">
                <img
                  src="/assets/imgs/page/homepage2/img-why.png"
                  alt="transp"
                />
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="cardWhyChooseUs mb-60">
                      <h2 className="color-brand-2">
                        <span>+</span>
                        <span className="count counterUp">
                          {inViewport && <CountUp end={346} duration={10} />}
                        </span>
                      </h2>
                      <h5 className="color-brand-2 mb-20">
                        Delivered packages.
                      </h5>
                    ...
                    <div className="cardWhyChooseUs mb-30">
                      <h2 className="color-brand-2">
                        ...
                        <span className="count">
                          {inViewport && <CountUp end={564} duration={10} />}
                        </span>
                      </h2>
                  ...
                  <div className="col-lg-6 mb-60 mt-50">
                    <div className="cardWhyChooseUs mb-60">
                      <h2 className="color-brand-2">
                        <span>+</span>
                        <span className="count">
                          {inViewport && <CountUp end={179} duration={10} />}
                        </span>
                      </h2>
                    ...
                    <div className="cardWhyChooseUs mb-30">
                      <h2 className="color-brand-2">
                        <span>+</span>
                        <span className="count">
                          {inViewport && <CountUp end={355} duration={10} />}
                        </span>
                      </h2>
